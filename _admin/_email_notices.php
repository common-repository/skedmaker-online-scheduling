...
if ($_SERVER['REQUEST_METHOD']=='POST' && $_GET['v']=='email_notices'){
	...
	if($errorMessage==""){
		...
		$saveIt=$wpdb->update("skedmaker_users", array('cancel'=>$cancel, 'confirmation'=>$confirmation, 'adminemail'=>$notice_email, 'BCC1'=>$notice_BCC1, 'BCC2'=>$notice_BCC2, 'BCC3'=>$notice_BCC3, 'send_notices_to_admin'=>$send_notices_to_admin, 'send_notices_to_client'=>$send_notices_to_client, 'send_notices_to_BCC'=>$send_notices_to_BCC), array("live"=>"y"));
...
<br><br>
Admin E-mail will be used to send appointment confirmations and cancellations to your clients. If this field is left blank, your clients will not be able to receive confirmations when they book with you.
</td></tr>

<tr><td class='label200'><?php SM_check_text("Admin E-mail:", $errorEmail);?></td>
<td class='pad7'><input name="notice_email" type="text" class='form_textfield' id="notice_email" value="<?php if($notice_email!=""){echo SM_d($notice_email);}else{echo SM_d($adminemail);}?>" maxlength="99"/>
</td></tr>
...
<tr><td style='text-align:center; padding:7px;'><?php echo $back_to_admin;?></td><td class='pad7'><input type="submit" name="button" id="button" value="Save Changes to Admin E-mail Address" /></td>
</tr></table>
</td></tr></table>
<br />
...
<tr><td style='text-align:center; padding:7px;'><?php echo $back_to_admin;?></td>

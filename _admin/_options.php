...
<tr><td class='pad7'><input name="limited_services" type="checkbox" id="limited_services" value="y" <?php if($limited_services=="y") {?> checked='checked'<?php }?>/></td>


<td class='pad7'><label for="limited_services"><b>Limit Available Services</b></label></td></tr>


<tr><td class='pad7'>&nbsp;</td><td style='padding:0px 14px 14px 7px;'>


<span class='smallG'>Check this box to allow only one service selection per time frame. Only applies to drop menu option.</span>

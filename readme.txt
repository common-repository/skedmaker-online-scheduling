...
1. From the Administration Home page menu, click on "List of Services".
2. On the Services page, type the name of the service you want to offer.
3. Add all of your services this way.
4. To "hide" a service from your list, click on the Deactivate icon.
5. To permanently delete a service, click on the Trash icon from the Deactivated Services list.
6. To reactivate a service, click on the green check icon in the Deactivated Services list.
7. To edit a service, click on the pencil icon. Make changes and click the Save Button.
